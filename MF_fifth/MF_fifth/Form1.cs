...
namespace MF_fifth
{
    public partial class Form1 : Form
    {
        ...
        public class Fuzzy
        {
            ...
            public static int Rank_D(Double x)
            {
            ...
            public static E FuzzyControl(Double y, Double e)
            {
            ...
            public static Double Calculate(Double e, Double e_dot)
            {
                Double[] Y1 = { 1, 0, 1, 0, 1 };
                Double[] Y2 = { 0, 1, 0, 1, 0 };
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i < 400; i++)
            {
                ...
                this.e[i] = Fuzzy.FuzzyControl(this.Y[i], this.e[i - 1].e);
                this.U[i] = Fuzzy.Calculate(this.e[i].e, this.e[i].e_dot);
